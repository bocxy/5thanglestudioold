...
class RemindersForQuoteGen extends Component {
        ...
        <div className="jr-card-header mb-3 d-flex align-items-center">
          <div className="mr-auto">
            <h3 className="card-heading mb-0">
              ...
              {/* Latest Notifications */}{this.props.title}
            </h3>
          </div>
...
RemindersForQuoteGen.propTypes = {
  theme: PropTypes.object.isRequired,
};

export default withStyles(null, {withTheme: true})(RemindersForQuoteGen);